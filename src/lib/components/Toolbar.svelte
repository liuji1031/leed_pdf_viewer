...
<div
	class="toolbar-top left-4 right-4 z-50"
					...
					<div class="relative highlight-color-container">
						...
						{#if showHighlightColorPicker}
							<div class="absolute top-full mt-2 left-0 z-50">
								...
								>
									<h3
										class="text-xs font-medium text-charcoal/80 dark:text-gray-300 mb-3 text-center"
									>
										Highlight Color
									</h3>
									<div class="grid grid-cols-4 gap-3">
						...
						<div class="relative export-menu-container">
							...
							{#if showExportMenu}
								<div class="absolute top-full mt-2 right-0 z-50 min-w-[180px]">
									<div
										class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-2"
									>
										{#if onSharePDF && !isSharedView}
											<button
		...
		>
			...
			{#if $drawingState.tool === 'text'}
				<div class="relative font-picker-container">
					...
					>
						<span class="truncate max-w-[60px]">
							{$availableFonts.find((f) => f.fontFamily === $drawingState.textFontFamily)?.name ||
								'Font'}
						</span>
						<svg
							class="w-3 h-3 flex-shrink-0"
...
{#if showHighlightColorPicker}
	<div class="fixed bottom-20 left-4 z-[70] lg:hidden">
		<div
			class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-4 min-w-[200px]"
		>
			<h3 class="text-xs font-medium text-charcoal/80 dark:text-gray-300 mb-3 text-center">
				Highlight Color
			</h3>
			<div class="grid grid-cols-4 gap-3">
				{#each availableHighlightColors as color}
